...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblGameID" runat="server" Text="CustomerID:" CssClass="auto-style3"></asp:Label>
        <br />
        <br />
        <asp:Label ID="lblDate" runat="server" Text="Email:" CssClass="auto-style6"></asp:Label>
        <asp:TextBox ID="txtDate" runat="server" CssClass="auto-style7"></asp:TextBox>
        <asp:Label ID="lblGameName" runat="server" Text="First Name:" CssClass="auto-style5"></asp:Label>
        <br />
        <br />
        <asp:Label ID="lblPrice" runat="server" Text="Surname:" CssClass="auto-style8"></asp:Label>
        <asp:TextBox ID="txtPrice" runat="server" CssClass="auto-style9"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="lblAgeRating" runat="server" Text="Phone Number:" CssClass="auto-style10"></asp:Label>
...
&nbsp;<asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="auto-style15" OnClick="btnCancel_Click" />
        <asp:CheckBox ID="chkAvailable" runat="server" Text="Marketing" OnCheckChanged="chkAvailable_CheckedChange" CssClass="auto-style12" BorderStyle="Solid" />
        <br />
        <br />
        <br />
        <br />
