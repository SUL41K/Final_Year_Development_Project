    ...
    public class clsStock
    {
        ...
        public string Valid(string gameName, string price, string ageRating, string releaseDate)
        {
            ...
            try
            {
                ...
                if (Convert.ToDecimal(price) > 2000)
                {
                    //output error message
                    Error = Error + "The price for this game is too high! Price must not exceed 2000 : ";
                }
            ...
            try
            {
                ...
                if (DateTemp < DateMin)
                {
                    ...
                    Error = Error + "The date cannot be before 2008 : ";
            ...
            try
            {
                ...
                if (Convert.ToInt32(ageRating) < 32)
                {
                    //Error message outputted to showcase error
                    Error = Error + "The age may not be less than 32  : ";
                }
                //If statement to ensure that the age rating does not exceed 18
                if (Convert.ToInt32(ageRating) > 512)
                {
                    //Error outputted otherwise
                    Error = Error + "Age must not be more than 512 : ";
                }
        ...
        public bool Find(int gameID)
        {
            ...
            public bool FindName(string gameName)
            {
